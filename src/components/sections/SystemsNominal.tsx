...
const telemetry = [
  { label: "SOFTWARE FOUNDATION", value: "ACTIVE", note: "JAVA, C++, DATA STRUCTURES, OOP" },
  { label: "INTELLIGENCE", value: "LEARNING", note: "ARTIFICIAL INTELLIGENCE, ML, GEN AI, CV" },
  { label: "FULL STACK", value: "BUILDING", note: "REACT, NEXT.JS, NODE.JS, DATABASES, APIs" },
  { label: "CREATIVE SYSTEMS", value: "ONLINE", note: "THREE.JS, GSAP, INTERACTIVE UI" },
];
    ...
    >
      <div className="mx-auto flex max-w-[1400px] flex-col gap-16 md:grid md:grid-cols-[5fr_4fr] md:gap-20">
        <AnimatedSection className="flex flex-col gap-8">
          <AnimatedItem>
            <EyebrowBadge>YUVA.OS // SYSTEMS NOMINAL</EyebrowBadge>
          </AnimatedItem>
          <AnimatedItem>
            <h2 className="max-w-[16ch] font-sans text-4xl font-semibold leading-[0.98] tracking-tighter text-foreground md:text-6xl">
              THE SYSTEM IS STILL <span className="text-accent">BUILDING.</span>
            </h2>
          </AnimatedItem>
          <AnimatedItem>
            <p className="max-w-[48ch] font-sans text-base leading-relaxed text-zinc-400 md:text-lg">
              Second year is not the final version. Every project, line of code, and architectural pattern is building toward a highly capable, full-stack intelligence layer. The telemetry below reflects current capabilities.
            </p>
          </AnimatedItem>
          <AnimatedItem>
            <a
