...
const DEFAULT_GLOW_COLOR = '212, 162, 47'; // Custom accent #d4a22f mapped to RGB
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {items.map((card, index) => {
          ...
          // Apply custom grid columns/rows if provided, else rely on CSS media queries
          const gridStyle: any = {};
          if (card.colSpan) gridStyle.gridColumn = `span ${card.colSpan}`;
          if (card.rowSpan) gridStyle.gridRow = `span ${card.rowSpan}`;
